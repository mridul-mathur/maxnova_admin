...
export default function UserTableRowCompany({
  selected,
  name,
  id,
  descripiton,
  ...
  const handleCatelogChange = (event) => {
    const file = event.target.files[0];
    if (!file) return;
    setFormData((prev) => ({
      ...prev,
  ...
  const handleEdit = () => {
    ...
    if (typeof formData.catalog !== "string") {
  ...
  return (
    <>
      ...
      <CustomeModel
        ...
        handleCatelog={handleCatelogChange}
