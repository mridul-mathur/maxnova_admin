...
export function updateHomeUtil(id, data) {
  return (dispatch) => {
    axios
      .patch(`/api/utils/patch-home/${id}`, data)
      .then((res) => {
...
export function updatePcdUtil(id, data) {
  return (dispatch) => {
    axios
      .patch(`/api/utils/patch-pcd/${id}`, data)
      .then((res) => {
        dispatch(getPcdUtil());
        dispatch({
          type: UPDATEPCDUTIL,
...
export function updatePvtUtil(id, data) {
  return (dispatch) => {
    axios
      .patch(`/api/utils/patch-pvt/${id}`, data)
      .then((res) => {
        dispatch(getPvtUtil());
        dispatch({
          type: UPDATEPVTUTIL,
...
export function updateCustomUtil(id, data) {
  return (dispatch) => {
    axios
      .patch(`/api/utils/patch-custom/${id}`, data)
      .then((res) => {
        ...
        dispatch(
          showSnackBar(
            "Updated Custom Formulatils Utils Successfully!",
            "success"
          )
        );
      })
...
export function updateAboutUtil(id, data) {
  return (dispatch) => {
    axios
      .patch(`/api/utils/patch-about/${id}`, data)
      .then((res) => {
...
export function deleteCertificate(id) {
  return (dispatch) => {
    axios
      .delete(`/api/utils/delete-certificate/${id}`)
      .then((res) => {
...
export function addCertificate(data) {
  return (dispatch) => {
    axios
      .post(`/api/utils/add-certificate`, data)
      .then((res) => {
        dispatch(getCertificates());
        dispatch({
          type: ADDCERTIFICATE,
